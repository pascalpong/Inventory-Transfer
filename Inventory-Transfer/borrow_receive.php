...
//echo $_SESSION['factory_code'];

              $conn = new Connect();
                    $sql = "select * from  inv_borrow where borrowing_factory = '{$_SESSION['factory_code']}' $status  $where_month   ";
//                    echo $sql.'<br>';
                ...
                while ($row = $conn->parseArray($rs)) {
                    ...
                    $get_info = " select factory_code,code from hr where code = '{$_SESSION['username']}' and  factory_code = '{$row['borrowing_factory']}' ";
//                    echo $get_info.'<br>';
                    ...
                    if($row_info['factory_code'] != $row['borrowing_factory']){
...
//                 echo $row_info['factory_code'].'<br>'.$row['lending_factory']; 
                    ...
                    ?>
                <tr style="cursor: pointer;" onclick="document.location.href='form_borrow_receive.php?tx_id=<? echo $row['tx_id']; ?>'">
