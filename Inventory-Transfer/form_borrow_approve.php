...
//         echo $sqlww;
        ...
        $remaininga =  $rowee['remain']-$row1ww['remain'];
                ...
                <td style="text-align: center;"><input type="number" name="lend_amt<? echo $y ?>" id="lend_amt<? echo $y ?>"    ><button onclick="checkFirst('<? echo $y ; ?>','<? echo $row["inv_code"] ?>')" >Submit</button></td>
