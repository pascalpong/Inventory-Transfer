...
$and_status = " and status != 'cancel' ";
              $conn = new Connect();
                  $sql = "select * from  inv_borrow where status != 'cancel'  $status  $where_month   ";
//  echo $sql;
...
//                 echo $row_info['factory_code'].'<br>'.$row['lending_factory']; 
                    ...
                    ?>
                <tr style="cursor: pointer;" onclick="document.location.href='form_borrow_lending.php?tx_id=<? echo $row['tx_id']; ?>'">
